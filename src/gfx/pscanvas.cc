...
// written: Mon Aug 27 19:06:39 2001
// $Id$
//
///////////////////////////////////////////////////////////////////////
...
public:
  ...
  void gsave() { indent(); itsFstream << "gsave\n"; ++itsIndentLevel; }
  void grestore() { --itsIndentLevel; indent(); itsFstream << "grestore\n"; }
...
//      indent(); itsFstream << "4 { pop } repeat\n";
  ...
  {
    if (itsGfxPrim != NONE)
      raiseError("nested calls to beginPrimitive()");
  ...
  {
    if (itsGfxPrim == NONE)
      raiseError("called endPrimitive() outside a graphics primitive");
