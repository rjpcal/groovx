...
test "ObjTogl-Togl::Init" "test widget create" {
	 if { ![Togl::inited] } { Togl::init "-rgba false"}
	 set ::TOGL_WIDTH [lindex [.togl_private configure -width] 4 ]
	 set ::TOGL_HEIGHT [lindex [.togl_private configure -height] 4 ]
	 update
} {^$}
...
} {Togl::setColor: colormap index out of range}
...
} {Togl::setViewingDistance: look out! you'll hurt your nose trying\
...
} {Togl::setViewingDistance: if you really insist on trying to view the\
